...
|                  |                                                                                                                          |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Source**       | https://github.com/bigkhangtheory/ComputerManagementTasks/tree/master/ComputerManagementTasks/DscResources/WindowsRolesAndFeatures |
...
### Table. Attributes of `WindowsRolesAndFeatures`
...
## Example `WindowsRolesAndFeatures`
